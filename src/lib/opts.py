...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--val_intervals', type=int, default=25,
    ...
    self.parser.add_argument('--no_color_aug', action='store_true',
                             help='not use the color augmenation '
                                  'from CornerNet')
    self.parser.add_argument('--class_remap', action='store_true',
                             help='remap classes to higher-level for grouping')     
    ...
    self.parser.add_argument('--unconf', action='store_true',
                             help='loss weight for bounding box size.')                         
    # multi_pose
