#!/bin/bash
python online_distillation.py ctdet_tracking --exp_id tracking_ds3_dla34_pt_tlost3_driving$1 --batch_size 1 \
    --lr 5e-4 --gpus 0 --num_workers 1 --num_epochs 1 \
    --arch dla_34 --freeze --track_feature \
    --num_iters 17824 \
    ...
    --momentum 0.9 --acc_collect --vidstream cv2 --umax 32 --downsample 3 --t_lost 3