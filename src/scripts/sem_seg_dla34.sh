python main.py ctdet_semseg  --exp_id resdcn_18_pt_seg_mAP80_thresh6_RMSProp_$1 --batch_size 1 --gpus 0 --num_workers 1 --num_epochs 1 \
    --arch dla_34 \
    --num_iters 1210 \
    ...
    --load_model /home/jl5/CenterNet/models/ctdet_coco_dla_34_2x.pth