#!/bin/bash
python online_distillation.py ctdet_stream  --exp_id results_resdcn18_baseline_model4_driving$1 --batch_size 1 --lr 5e-4 --gpus 0 --num_workers 1 --num_epochs 1 \
    --arch resdcn_18 \
    --num_iters 17824 \
    ...
    --load_model /data2/jl5/centdt_exp/ctdet/driving_resdcn18_epoch/model_4.pth \
