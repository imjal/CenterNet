#!/bin/bash
python online_distillation.py ctdet_stream --exp_id tmp_downsample3_dla34_pt_driving$1 --batch_size 1 --lr 5e-4 --gpus 0 --num_workers 1 --num_epochs 1 \
    --arch dla_34 --track_feature --freeze \
    --num_iters 17824 \
    ...
    --adaptive --display_timing --center_thresh 0.5 --vis_thresh 0.6 --lr 0.00001 \
