#!/bin/bash
python main.py ctdet_stream  --exp_id tmp_dla34_pt_driving$1_$2 --batch_size 1 --lr 5e-4 --gpus 0 --num_workers 1 --num_epochs 1 \
    --arch dla_34 \
    --num_iters 17824 \
    ...
    --momentum 0.9 --acc_collect --vidstream cv2 --umax $2
