#!/bin/bash
python online_distillation.py ctdet_stream  --exp_id dla34_pt_mAP80_thresh6_$1 --batch_size 1 --lr 5e-4 --gpus 0 --num_workers 1 --num_epochs 1 \
    --arch dla_34 \
    --num_iters 1210 \
    ...
    --display_timing --adaptive --center_thresh 0.5 --vis_thresh 0.5 --lr 0.0001 --momentum 0.9 --acc_collect --vidstream skvideo