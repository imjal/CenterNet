python main.py ctdet_semseg  --exp_id adaptive_pretrained --batch_size 1 --lr 5e-4 --gpus 0 --num_workers 1 --num_epochs 1 \
    --arch dla_34 \
    --num_iters 1210 \
    ...
    --load_model /home/jl5/CenterNet/models/ctdet_coco_dla_2x.pth --replay_samples 4
